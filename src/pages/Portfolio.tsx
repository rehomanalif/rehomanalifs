        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 mb-12 sm:mb-16">
            ...
            {[
              ...
              <Card key={index} className="text-center group hover:shadow-xl transition-all duration-300 border-0 shadow-lg" data-aos="fade-up" data-aos-delay={index * 100}>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div data-aos="fade-right">
              ...
              <div className="space-y-6">
                {[
                  { skill: "Meta Ads Management", percentage: 98, color: "from-primary to-secondary" },
                  { skill: "Social Media Marketing", percentage: 95, color: "from-secondary to-accent" },
                  { skill: "Web Design & Development", percentage: 92, color: "from-accent to-primary" },
                  { skill: "Email Marketing", percentage: 88, color: "from-primary to-accent" }
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:sticky lg:top-24 lg:h-fit space-y-4" data-aos="fade-right">
              ...
              {[
                { key: 'Social Media Marketing', icon: MessageSquare, label: 'Social Media Marketing' },
                { key: 'Meta Ad Campaigns', icon: Target, label: 'Meta Ad Campaigns' },
                { key: 'Web Design', icon: Monitor, label: 'Web Design' },
                { key: 'Email Marketing', icon: MailIcon, label: 'Email Marketing' }
              ].map((category) => (
                <Button
                  key={category.key}
                  ...
                  className={`w-full justify-start p-4 h-auto transition-all duration-300 ${
                    portfolioFilter === category.key 
                      ? 'bg-gradient-primary text-white shadow-lg' 
                      : 'hover:bg-primary/5 hover:text-primary border border-border'
                  }`}
                >
            ...
            <div className="lg:col-span-3 space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                ].filter(project => project.category === portfolioFilter)
                .map((project, index) => (
                  <Card key={index} className="group overflow-hidden hover:shadow-xl transition-all duration-300 border-0 shadow-lg" data-aos="fade-up" data-aos-delay={index * 100}>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <Card key={index} className="relative text-center group hover:shadow-lg transition-all duration-300 border-0 shadow-md" data-aos="fade-up" data-aos-delay={index * 100}>
                <CardContent className="p-4 sm:p-6">
            ...
            <div data-aos="fade-right" className="space-y-6">
              <Card className="bg-gradient-to-br from-primary via-secondary to-accent text-white p-6 sm:p-8 border-0 shadow-xl">
                <div className="space-y-6">
                  ...
                  <Button 
                    onClick={() => window.open('https://www.fiverr.com/alifpixelpro', '_blank')}
                    className="w-full bg-white text-primary hover:bg-white/90 py-3 font-semibold rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300"
                  >
            ...
            <div data-aos="fade-left">
              <Accordion type="single" collapsible className="space-y-3">
                {[
                  ...
                  <AccordionItem key={index} value={`item-${index}`} className="bg-white rounded-lg border-0 shadow-sm px-4 sm:px-6">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <Card key={index} className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-0 shadow-lg" data-aos="fade-up" data-aos-delay={index * 100}>
